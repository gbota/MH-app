...
// Create a new event
router.post('/events/:calendarId', auth, async (req, res) => {
    try {
        const { calendarId } = req.params;
...
// Update an event
router.put('/events/:calendarId/:eventId', auth, async (req, res) => {
    try {
...
// Delete an event
router.delete('/events/:calendarId/:eventId', auth, async (req, res) => {
    try {
        const { calendarId, eventId } = req.params;
...
router.get('/free-slots/:calendarId', auth, async (req, res) => {
    try {
        const { calendarId } = req.params;
